...
Deploy: Vercel (siempre incluir esta linea para proyectos web, landing pages, VSLs, funnels, paginas de ventas, APIs o backends. OMITIR completamente para apps moviles/celulares.)
